...
@onready var isi_teks_dokuemen: RichTextLabel = $"CanvasLayer3/DokumenPanel/Isi Teks Dokuemen"
...
func _ready() -> void:
	...
	isi_teks_dokuemen.bbcode_enabled = true
	update_point_label()
...
func _process(_delta: float) -> void:
	...
	if Input.is_action_just_pressed("interact") and dokumen_terbuka:
		tutup_dokumen()
...
func buka_dokumen(id: int) -> void:
	...
	isi_teks_dokuemen.clear()
	isi_teks_dokuemen.text = dokumen[id]
